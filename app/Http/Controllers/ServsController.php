...
class ServsController extends Controller
{
  ...
  */
  public function edit($id)
  {
    ...
    return view('servicio.editserv',["servicio" => $servicio,"status" => $status, "user" => $user, "garantia" => $garantia, "pagor" => $pagor, "articulos" => $articulos, "cli" => $cli, "detalles" => $detalles, "email" => $email, "id" => $id, "serviciohijo" => $serviciohijo]);
