...
class ComprasController extends Controller
{
    ...
    public function create()
    {
        ...
        $servicio = Serv::where('status_id', '<>', 10)->orderBy('id', 'asc')->lists('id', 'id'); //agregue el orden
         $mensajero_id = User::where('perfil_id', '=', 4)->lists('name', 'id');; //id del mensajero;
        return view('compras.create',compact('servicio','proveedor','status','mensajero_id'));//variables a las que asigne campos reales de la base de datos
    }
