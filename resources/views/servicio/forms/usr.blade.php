...
$(function() {
	...
	<div class="form-group col-md-4">
		...
		{!!Form::text('fechaentrega', \Carbon\Carbon::now())!!}
	</div>

	<div class="form-group col-md-4">
		{!!Form::label('fechanotifica','¿Cuando se notifica para entrega?:')!!}
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse2">1.- Desplegar información de pagos</a>
      </h4>
    </div>
	...
	<div class="form-group col-md-4 ">
		...
		{!!Form::date('fechapago1', \Carbon\Carbon::now())!!}
	</div>
	...
	<div class="form-group col-md-4">
		...
		{!!Form::date('fechapago2', \Carbon\Carbon::now())!!}
	</div>
...
<div class="panel-group col-md-14">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse1">2.- Desplegar orden de servicio</a>
      </h4>
    </div>
