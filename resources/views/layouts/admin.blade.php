            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-ambulance"></i> Ordenes de Servicio<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                               ...
                               <li>
                                    <a href="{!!URL::to('servicio/show')!!}"><i class='fa fa-thumbs-o-up'></i> Ordenes de servicio entregadas</a>
                                </li>
                                <li>
                                <a href="#"><i class='fa fa-bicycle'></i>Solicitar recolección de equipo</a>
                                     <ul class="nav nav-third-level">
