	...
	<div class="form-group">
		...
		{!!Form::text('precio',null,['class'=>'form-control','placeholder'=>'$00.00'])!!}
	</div>

	<div class="form-group">
		{!!Form::label('pre','Precio a publico:')!!}
		{!!Form::number('preciop',null,['class'=>'form-control','placeholder'=>'$00.00'])!!}
	...
	<div class="list-group">
		{!!Form::label('Sucursal','Sucursal de asignación:')!!}
